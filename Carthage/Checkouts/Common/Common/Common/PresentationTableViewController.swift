...
//
//  Created by Wyeth Shamp on 5/15/16.
...
open class PresentationTableViewController: UITableViewController {
...
extension PresentationTableViewController : UIViewControllerTransitioningDelegate {
